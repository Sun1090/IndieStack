  ...
  "relative w-full rounded-lg border p-4 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-foreground",
  {
    variants: {
      variant: {
        ...
        warning: "border-orange-500/50 text-orange-600 dark:text-orange-400 dark:border-orange-400/50",
        success: "border-green-500/50 text-green-600 dark:text-green-400 dark:border-green-400/50",
