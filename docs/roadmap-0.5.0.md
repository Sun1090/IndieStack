...
| F02 | E2E：admin/contact/MFA 页面补齐 | v0.4.0 新页面 Playwright 用例补齐（2026-09-05 完成：5 用例全绿，contact 表单 name 属性 bug 顺手修；mock 缓存切 globalThis 解决 Next.js dev Turbopack 跨 chunk 不可见问题） |
