...
| `pnpm check:query-columns` | Check literal column names in Supabase query chains, and the keys of `insert`/`update`/`upsert` payloads, against the generated row and Insert/Update types |
