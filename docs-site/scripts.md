...
| `pnpm check:cron-contract` | Audit Vercel cron schedules, route methods, rejection observability, documented metrics, and that every conditional skip in a worker route reports a counter |
