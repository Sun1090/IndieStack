...
- [ ] [v0.7.0 发布 Runbook](../docs/operations/release-runbook-v0.7.0.md) 的 commit、迁移、观察窗口字段已填写
- [ ] [生产 Smoke Test](../docs/operations/production-smoke-v0.7.0.md) 每项均有时间、状态和证据
- [ ] [回滚 Runbook](../docs/operations/rollback-runbook-v0.7.0.md) 已由操作者和审查者复核；数据库回滚决策已明确
